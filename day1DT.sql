...
INSERT INTO students values(1002, 'Veli Han', 90.50, now());
...
———————————————————*/
---1 Tablo Oluşturma
CREATE TABLE tedarikciler (tedarikci_id INTEGER ,tedarikci_ismi VARCHAR(20),tedarikci_adres VARCHAR(20),ulasim_tarihi DATE);
...
CREATE TABLE ogretmenler (kimlik_no INT PRIMARY KEY ,
isim VARCHAR(50),brans VARCHAR(20),cinsiyet varchar(10)
);
...
INSERT INTO actors (name) VALUES ('Sener Sen');--değer girilmeyen diğer sutunlar null oldu.ABORT
